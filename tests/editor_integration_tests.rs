...
fn test_undo_after_edit_string() {
    ...
    // Edit the value
    state.set_edit_buffer_for_test("modified".to_string());
...
fn test_undo_after_edit_integer() {
    ...
    // Edit the value
    state.set_edit_buffer_for_test("100".to_string());
    state.commit_editing().unwrap();
...
fn test_undo_after_edit_float() {
    ...
    // Edit the value
    state.set_edit_buffer_for_test("2.71".to_string());
    state.commit_editing().unwrap();
...
fn test_undo_after_edit_boolean() {
    ...
    // Edit the value
    state.set_edit_buffer_for_test("false".to_string());
    state.commit_editing().unwrap();
...
fn test_multi_step_undo_redo() {
    ...
    // First edit
    state.set_edit_buffer_for_test("edit1".to_string());
    state.commit_editing().unwrap();

    // Second edit
    state.set_edit_buffer_for_test("edit2".to_string());
    state.commit_editing().unwrap();
...
fn test_undo_preserves_yaml_string_style_plain() {
    ...
    // Edit the value
    state.set_edit_buffer_for_test("modified plain".to_string());
    state.commit_editing().unwrap();
...
fn test_undo_preserves_yaml_string_style_literal() {
    ...
    // Edit the value
    state.set_edit_buffer_for_test("modified\nliteral".to_string());
    state.commit_editing().unwrap();
...
fn test_undo_preserves_yaml_string_style_folded() {
    ...
    // Edit the value
    state.set_edit_buffer_for_test("modified folded".to_string());
    state.commit_editing().unwrap();
...
fn test_edit_null_and_undo() {
    ...
    state.set_edit_buffer_for_test("null".to_string());
    state.commit_editing().unwrap();
